<div class="nav-grid">
    <aside class="menu">
        ...
        <a id="create" class="menu__item {{ request()->routeIs('create') ? 'link--active' : '' }}"
            href="{{ route('create') }}">
            <div class="menu__item-link">
        ...
        <a id="delete" class="menu__item {{ request()->routeIs('delete') ? 'link--active' : '' }}"
            href="{{ route('delete') }}">
            <div class="menu__item-link">
        ...
        <a id="update" class="menu__item {{ request()->routeIs('update') ? 'link--active' : '' }}"
            href="{{ route('update') }}">
            <div class="menu__item-link">
        ...
        <a id="dashboard" class="menu__item {{ request()->routeIs('dashboard') ? 'link--active' : '' }}"
